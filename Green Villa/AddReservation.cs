...
namespace Green_Villa
{
    public partial class AddReservation : Form
    {
        ...
        {
            dateReservation.MinDate = DateTime.Today;
        ...
        public void GridViewDataLoad()
        {
            ...
            string query1 = "SELECT roomNum FROM reservation WHERE NOT (startDate > @endDate OR endDate < @startDate)";
        ...
        private void btnContinue_Click(object sender, EventArgs e)
        {
            if (gridviewAvailableRooms.SelectedRows.Count == 1)
            {
                ...
                SelectGuest sg = new SelectGuest();
                this.Hide();
                sg.ShowDialog();
            }
            else
